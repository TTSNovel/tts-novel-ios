...
/// VieNeuV2CodecDecoder), bundled individually as `Resources/VieNeuOffline/
...
public enum VieNeuOfflineV2Voice: String, CaseIterable, Identifiable, Codable, Sendable {
