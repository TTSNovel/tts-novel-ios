...
public enum TTSVoice: String, CaseIterable, Identifiable, Codable, Sendable {
    ...
    public var isOffline: Bool { self == .piperOffline || self == .vieNeuOfflineV2 || self == .vieNeuOfflineV3 }
}
