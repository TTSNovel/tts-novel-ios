...
public enum TranslationEngineKind: String, CaseIterable, Identifiable, Sendable {
    case apple
    case opusMT
...
public enum PrimaryLanguageOption: String, CaseIterable, Identifiable, Sendable {
    case vietnamese = "vi"
    case english = "en"
