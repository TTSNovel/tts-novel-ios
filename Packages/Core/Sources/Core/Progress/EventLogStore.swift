...
@MainActor
public final class EventLogStore: ObservableObject {
    ...
    @Published public private(set) var events: [AppEvent] = []
    ...
    public func record(_ category: AppEventCategory, _ message: String, detail: String? = nil) {
    ...
    public func entries(matching categories: Set<AppEventCategory>? = nil, since: Date? = nil) -> [AppEvent] {
